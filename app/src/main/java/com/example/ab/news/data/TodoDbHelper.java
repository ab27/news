...
public class TodoDbHelper  extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        final String SQL_CREATE_ITEMS_TABLE = "CREATE TABLE " + TodoContract.TodoEntry.TABLE_NAME + " (" +
                TodoContract.TodoEntry._ID + " INTEGER PRIMARY KEY AUTOINCREMENT," +
                TodoContract.TodoEntry.COLUMN_TODO_Entry + " TEXT NOT NULL, " +
                TodoContract.TodoEntry.COLUMN_TODO_ORIGIN + " REAL NOT NULL);";

...
public class TodoProvider extends ContentProvider {
    ...
    private static final int TODO_ID = 301;
    ...
    private static UriMatcher buildUriMatcher() {
        ...
        // code.
        matcher.addURI(authority, TodoContract.PATH_ITEMS, TODO);
        matcher.addURI(authority, TodoContract.PATH_ITEMS + "/#", TODO_ID);
        ...
        switch (rUriMatcher.match(uri)) {
            ...
            case TODO_ID: {
                retCursor = mOpenHelper.getReadableDatabase().query(
                        ...
                        projection,
                        TodoContract.TodoEntry._ID + " = '" + ContentUris.parseId(uri) + "'",
                        null,
                        null,
                        null,
                        sortOrder
    ...
    public String getType(Uri uri) {
        ...
        switch(match) {
            case TODO:
                return TodoContract.TodoEntry.CONTENT_TYPE; // a single item
            case TODO_ID:
                return TodoContract.TodoEntry.CONTENT_ITEM_TYPE; // a directory (list) of items
            default:
                throw new UnsupportedOperationException("Unknown uri: " + uri);
        }
    }
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (match) {
            case TODO: {
                ...
                if ( _id > 0 )
                    returnUri = TodoContract.TodoEntry.buildLocationUri(_id);
                else
        ...
        switch (match) {
            case TODO: {
                rowsUpdated = db.update(
                        TodoContract.TodoEntry.TABLE_NAME, values, selection, selectionArgs);
                break;
            }
            default:
                throw new UnsupportedOperationException("Unknown uri: " + uri);
